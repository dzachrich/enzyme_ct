defmodule MapCompareTest do
  ...
  setup do
    m1 = %{"a" => "this", "b" => "that", "c" => true, "d" => 123, "e" => [1,"the other",%{ "h" => "value1"}], "f" => %{ "g" => "some value", "h" => %{ "j" => 1, "k" => [1,2,3]}}}
    m2 = %{"a" => "this", "b" => "that", "c" => true, "d" => 123, "e" => [1,"the other 2",%{ "h" => "value2"}], "f" => %{ "g" => "some value", "h" => %{ "j" => 2}}}
